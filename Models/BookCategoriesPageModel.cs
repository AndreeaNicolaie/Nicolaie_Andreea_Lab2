...
namespace Nicolaie_Andreea_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Nicolaie_Andreea_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Nicolaie_Andreea_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
